...
class Cow final {
 public:
  ...
  Cow(const T& value HORUS_LIFETIME_BOUND) noexcept  // NOLINT(*-explicit-*)
      : value_{InPlaceType<const T*>, &value} {}

  /// Returns a reference to the inner value.
  const T& Ref() const noexcept HORUS_LIFETIME_BOUND {
  ...
  T& Mutable() noexcept(std::is_nothrow_copy_constructible<T>::value) HORUS_LIFETIME_BOUND {
