...
class LogData final : public PbMessage {
 public:
  ...
  // Field `obstruction_detector_bad_reference_warning` (no 169).
  // -----

  /// No documentation.
  ///
  /// Field no: 169.
  constexpr const logs::ObstructionDetectorBadReferenceWarning& obstruction_detector_bad_reference_warning() const& noexcept HORUS_LIFETIME_BOUND {
    return obstruction_detector_bad_reference_warning_;
  }

  /// If `obstruction_detector_bad_reference_warning` is set, moves it out of the message (without marking it as unset).
  ///
  /// Otherwise, returns a default-initialized value.
  ///
  /// Field no: 169.
  ...
  /// Sets `obstruction_detector_bad_reference_warning` (no 169) and returns `*this`.
  ...
  /// Sets `obstruction_detector_bad_reference_warning` (no 169) and returns `*this`.
  LogData&& set_obstruction_detector_bad_reference_warning(logs::ObstructionDetectorBadReferenceWarning&& obstruction_detector_bad_reference_warning) && noexcept {
    return std::move(set_obstruction_detector_bad_reference_warning(std::move(obstruction_detector_bad_reference_warning)));
  }

  // Field `project_file_invalid_permissions_error` (no 170).
  // -----

  /// No documentation.
  ///
  /// Field no: 170.
  constexpr const logs::ProjectFileInvalidPermissionsError& project_file_invalid_permissions_error() const& noexcept HORUS_LIFETIME_BOUND {
    return project_file_invalid_permissions_error_;
  }

  /// If `project_file_invalid_permissions_error` is set, moves it out of the message (without marking it as unset).
  ///
  /// Otherwise, returns a default-initialized value.
  ///
  /// Field no: 170.
  ...
  /// Sets `project_file_invalid_permissions_error` (no 170) and returns `*this`.
  ...
  /// Sets `project_file_invalid_permissions_error` (no 170) and returns `*this`.
  LogData&& set_project_file_invalid_permissions_error(logs::ProjectFileInvalidPermissionsError&& project_file_invalid_permissions_error) && noexcept {
    return std::move(set_project_file_invalid_permissions_error(std::move(project_file_invalid_permissions_error)));
  }

  // Field `pipeline_scheduler_error` (no 171).
  // -----

  /// No documentation.
  ///
  /// Field no: 171.
  constexpr const logs::PipelineSchedulerError& pipeline_scheduler_error() const& noexcept HORUS_LIFETIME_BOUND {
    return pipeline_scheduler_error_;
  }

  /// If `pipeline_scheduler_error` is set, moves it out of the message (without marking it as unset).
  ///
  /// Otherwise, returns a default-initialized value.
  ///
  /// Field no: 171.
  ...
  /// Sets `pipeline_scheduler_error` (no 171) and returns `*this`.
  ...
  /// Sets `pipeline_scheduler_error` (no 171) and returns `*this`.
  LogData&& set_pipeline_scheduler_error(logs::PipelineSchedulerError&& pipeline_scheduler_error) && noexcept {
    return std::move(set_pipeline_scheduler_error(std::move(pipeline_scheduler_error)));
  }

  // Field `multi_lidar_calibration_warning` (no 172).
  // -----

  /// No documentation.
  ///
  /// Field no: 172.
  constexpr const logs::MultiLidarCalibrationWarning& multi_lidar_calibration_warning() const& noexcept HORUS_LIFETIME_BOUND {
    return multi_lidar_calibration_warning_;
  }

  /// If `multi_lidar_calibration_warning` is set, moves it out of the message (without marking it as unset).
  ///
  /// Otherwise, returns a default-initialized value.
  ///
  /// Field no: 172.
  ...
  /// Sets `multi_lidar_calibration_warning` (no 172) and returns `*this`.
  ...
  /// Sets `multi_lidar_calibration_warning` (no 172) and returns `*this`.
  LogData&& set_multi_lidar_calibration_warning(logs::MultiLidarCalibrationWarning&& multi_lidar_calibration_warning) && noexcept {
    return std::move(set_multi_lidar_calibration_warning(std::move(multi_lidar_calibration_warning)));
  }

  // Field `multi_lidar_calibration_error` (no 173).
  // -----

  /// No documentation.
  ///
  /// Field no: 173.
  constexpr const logs::MultiLidarCalibrationError& multi_lidar_calibration_error() const& noexcept HORUS_LIFETIME_BOUND {
    return multi_lidar_calibration_error_;
  }

  /// If `multi_lidar_calibration_error` is set, moves it out of the message (without marking it as unset).
  ///
  /// Otherwise, returns a default-initialized value.
  ///
  /// Field no: 173.
  ...
  /// Sets `multi_lidar_calibration_error` (no 173) and returns `*this`.
  ...
  /// Sets `multi_lidar_calibration_error` (no 173) and returns `*this`.
  LogData&& set_multi_lidar_calibration_error(logs::MultiLidarCalibrationError&& multi_lidar_calibration_error) && noexcept {
    return std::move(set_multi_lidar_calibration_error(std::move(multi_lidar_calibration_error)));
  }

  // Field `old_bag_warning` (no 174).
  // -----

  /// No documentation.
  ///
  /// Field no: 174.
  constexpr const logs::OldBagWarning& old_bag_warning() const& noexcept HORUS_LIFETIME_BOUND {
    return old_bag_warning_;
  }

  /// If `old_bag_warning` is set, moves it out of the message (without marking it as unset).
  ///
  /// Otherwise, returns a default-initialized value.
  ///
  /// Field no: 174.
  ...
  /// Sets `old_bag_warning` (no 174) and returns `*this`.
  ...
  /// Sets `old_bag_warning` (no 174) and returns `*this`.
  LogData&& set_old_bag_warning(logs::OldBagWarning&& old_bag_warning) && noexcept {
    return std::move(set_old_bag_warning(std::move(old_bag_warning)));
  }

  // Field `upgrading_bag_info` (no 175).
  // -----

  /// No documentation.
  ///
  /// Field no: 175.
  constexpr const logs::UpgradingBagInfo& upgrading_bag_info() const& noexcept HORUS_LIFETIME_BOUND {
    return upgrading_bag_info_;
  }

  /// If `upgrading_bag_info` is set, moves it out of the message (without marking it as unset).
  ///
  /// Otherwise, returns a default-initialized value.
  ///
  /// Field no: 175.
  ...
  /// Sets `upgrading_bag_info` (no 175) and returns `*this`.
  ...
  /// Sets `upgrading_bag_info` (no 175) and returns `*this`.
  LogData&& set_upgrading_bag_info(logs::UpgradingBagInfo&& upgrading_bag_info) && noexcept {
    return std::move(set_upgrading_bag_info(std::move(upgrading_bag_info)));
  }

  // Field `bag_calibration_save_failed` (no 176).
  // -----

  /// No documentation.
  ///
  /// Field no: 176.
  constexpr const logs::BagCalibrationSaveFailed& bag_calibration_save_failed() const& noexcept HORUS_LIFETIME_BOUND {
    return bag_calibration_save_failed_;
  }

  /// If `bag_calibration_save_failed` is set, moves it out of the message (without marking it as unset).
  ///
  /// Otherwise, returns a default-initialized value.
  ///
  /// Field no: 176.
  ...
  /// Sets `bag_calibration_save_failed` (no 176) and returns `*this`.
  ...
  /// Sets `bag_calibration_save_failed` (no 176) and returns `*this`.
  LogData&& set_bag_calibration_save_failed(logs::BagCalibrationSaveFailed&& bag_calibration_save_failed) && noexcept {
    return std::move(set_bag_calibration_save_failed(std::move(bag_calibration_save_failed)));
  }

  // Field `bag_upgrade_failed` (no 177).
  // -----

  /// No documentation.
  ///
  /// Field no: 177.
  constexpr const logs::BagUpgradeFailed& bag_upgrade_failed() const& noexcept HORUS_LIFETIME_BOUND {
    return bag_upgrade_failed_;
  }

  /// If `bag_upgrade_failed` is set, moves it out of the message (without marking it as unset).
  ///
  /// Otherwise, returns a default-initialized value.
  ///
  /// Field no: 177.
  ...
  /// Sets `bag_upgrade_failed` (no 177) and returns `*this`.
  ...
  /// Sets `bag_upgrade_failed` (no 177) and returns `*this`.
  LogData&& set_bag_upgrade_failed(logs::BagUpgradeFailed&& bag_upgrade_failed) && noexcept {
    return std::move(set_bag_upgrade_failed(std::move(bag_upgrade_failed)));
  }

  // Field `unknown_lidar_error` (no 178).
  // -----

  /// No documentation.
  ///
  /// Field no: 178.
  constexpr const logs::UnknownLidarError& unknown_lidar_error() const& noexcept HORUS_LIFETIME_BOUND {
    return unknown_lidar_error_;
  }

  /// If `unknown_lidar_error` is set, moves it out of the message (without marking it as unset).
  ///
  /// Otherwise, returns a default-initialized value.
  ///
  /// Field no: 178.
  ...
  /// Sets `unknown_lidar_error` (no 178) and returns `*this`.
  ...
  enum class DataOneof : std::uint32_t {  // NOLINT(*-enum-size)
    ...
    /// @see obstruction_detector_bad_reference_warning()
    kObstructionDetectorBadReferenceWarning = 169,
    /// @see project_file_invalid_permissions_error()
    kProjectFileInvalidPermissionsError = 170,
    /// @see pipeline_scheduler_error()
    kPipelineSchedulerError = 171,
    /// @see multi_lidar_calibration_warning()
    kMultiLidarCalibrationWarning = 172,
    /// @see multi_lidar_calibration_error()
    kMultiLidarCalibrationError = 173,
    /// @see old_bag_warning()
    kOldBagWarning = 174,
    /// @see upgrading_bag_info()
    kUpgradingBagInfo = 175,
    /// @see bag_calibration_save_failed()
    kBagCalibrationSaveFailed = 176,
    /// @see bag_upgrade_failed()
  ...
  void clear_data() noexcept {
    switch (data_) {
      ...
      case DataOneof::kObstructionDetectorBadReferenceWarning: {
        clear_obstruction_detector_bad_reference_warning();
        break;
      }
      case DataOneof::kProjectFileInvalidPermissionsError: {
        clear_project_file_invalid_permissions_error();
        break;
      }
      case DataOneof::kPipelineSchedulerError: {
        clear_pipeline_scheduler_error();
        break;
      }
      case DataOneof::kMultiLidarCalibrationWarning: {
        clear_multi_lidar_calibration_warning();
        break;
      }
      case DataOneof::kMultiLidarCalibrationError: {
        clear_multi_lidar_calibration_error();
        break;
      }
      case DataOneof::kOldBagWarning: {
        clear_old_bag_warning();
        break;
      }
      case DataOneof::kUpgradingBagInfo: {
        clear_upgrading_bag_info();
        break;
      }
      case DataOneof::kBagCalibrationSaveFailed: {
        clear_bag_calibration_save_failed();
        break;
      }
      case DataOneof::kBagUpgradeFailed: {
        clear_bag_upgrade_failed();
        break;
      }
      case DataOneof::kUnknownLidarError: {
 ...
 private:
  ...
  /// @see obstruction_detector_bad_reference_warning()
  logs::ObstructionDetectorBadReferenceWarning obstruction_detector_bad_reference_warning_{};
  /// @see project_file_invalid_permissions_error()
  logs::ProjectFileInvalidPermissionsError project_file_invalid_permissions_error_{};
  /// @see pipeline_scheduler_error()
  logs::PipelineSchedulerError pipeline_scheduler_error_{};
  /// @see multi_lidar_calibration_warning()
  logs::MultiLidarCalibrationWarning multi_lidar_calibration_warning_{};
  /// @see multi_lidar_calibration_error()
  logs::MultiLidarCalibrationError multi_lidar_calibration_error_{};
  /// @see old_bag_warning()
  logs::OldBagWarning old_bag_warning_{};
  /// @see upgrading_bag_info()
  logs::UpgradingBagInfo upgrading_bag_info_{};
  /// @see bag_calibration_save_failed()
  logs::BagCalibrationSaveFailed bag_calibration_save_failed_{};
  /// @see bag_upgrade_failed()
