...
class ScopeGuard final {
  static_assert(noexcept(std::declval<F const&>()()), "ScopeGuard handler must be noexcept");
 ...
 public:
  ...
  constexpr ScopeGuard(ScopeGuard&&) noexcept = default;
  /// Cannot move-assign a `ScopeGuard`.
  constexpr ScopeGuard& operator=(ScopeGuard&&) & noexcept = delete;
