...
/// Tag type used to implement `InPlaceIndex<T>`.
...
/// Value used to pass constant indices to constructors.
///
/// @see https://en.cppreference.com/w/cpp/utility/in_place
template <std::size_t I>
constexpr void InPlaceIndex(horus_internal::InPlaceIndexTag<I> /* tag */) {}

/// Marker type for `InPlaceIndex<T>`.
///
/// @see https://en.cppreference.com/w/cpp/utility/in_place
template <std::size_t I>
using InPlaceIndexT = void (*)(horus_internal::InPlaceIndexTag<I>);
