...
type Quaterniond struct {
	state         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Qw float64                `protobuf:"fixed64,1,opt,name=qw,proto3" json:"qw,omitempty"`
	xxx_hidden_Qx float64                `protobuf:"fixed64,2,opt,name=qx,proto3" json:"qx,omitempty"`
	xxx_hidden_Qy float64                `protobuf:"fixed64,3,opt,name=qy,proto3" json:"qy,omitempty"`
	xxx_hidden_Qz float64                `protobuf:"fixed64,4,opt,name=qz,proto3" json:"qz,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Quaterniond) Reset() {
	*x = Quaterniond{}
...
func (x *Quaterniond) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Quaterniond) ProtoMessage() {}

func (x *Quaterniond) ProtoReflect() protoreflect.Message {
	mi := &file_horus_pb_config_metadata_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *Quaterniond) GetQw() float64 {
	if x != nil {
		return x.xxx_hidden_Qw
	}
	return 0
}

func (x *Quaterniond) GetQx() float64 {
	if x != nil {
		return x.xxx_hidden_Qx
	}
	return 0
}

func (x *Quaterniond) GetQy() float64 {
	if x != nil {
		return x.xxx_hidden_Qy
	}
	return 0
}

func (x *Quaterniond) GetQz() float64 {
	if x != nil {
		return x.xxx_hidden_Qz
	}
	return 0
}

func (x *Quaterniond) SetQw(v float64) {
	x.xxx_hidden_Qw = v
}

func (x *Quaterniond) SetQx(v float64) {
	x.xxx_hidden_Qx = v
}

func (x *Quaterniond) SetQy(v float64) {
	x.xxx_hidden_Qy = v
}

func (x *Quaterniond) SetQz(v float64) {
	x.xxx_hidden_Qz = v
}

type Quaterniond_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 Quaterniond_builder) Build() *Quaterniond {
	m0 := &Quaterniond{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Qw = b.Qw
	x.xxx_hidden_Qx = b.Qx
	x.xxx_hidden_Qy = b.Qy
	x.xxx_hidden_Qz = b.Qz
	return m0
}
...
var file_horus_pb_config_metadata_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x02, 0x52, 0x01, 0x7a, 0x22, 0x4d, 0x0a, 0x0b, 0x51, 0x75, 0x61, 0x74,
	0x65, 0x72, 0x6e, 0x69, 0x6f, 0x6e, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x71, 0x77, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x01, 0x52, 0x02, 0x71, 0x77, 0x12, 0x0e, 0x0a, 0x02, 0x71, 0x78, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x01, 0x52, 0x02, 0x71, 0x78, 0x12, 0x0e, 0x0a, 0x02, 0x71, 0x79, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x01, 0x52, 0x02, 0x71, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x71, 0x7a, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x01, 0x52, 0x02, 0x71, 0x7a, 0x22, 0x2f, 0x0a, 0x05, 0x52, 0x61, 0x6e, 0x67, 0x65,
